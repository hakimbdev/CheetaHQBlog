...
const Sidebar: React.FC<SidebarProps> = ({ darkMode, setDarkMode, currentPage, setCurrentPage, isOpen = false, onClose }) => {
  const menuItems = [
    ...
    { icon: Image, label: 'Explore NFTs', page: 'explore-nfts' as const },
    { icon: FileText, label: 'Blog', page: 'blog' as const },
  ...
  if (typeof window !== 'undefined' && window.innerWidth < 768) {
    ...
    return (
      <div className="fixed inset-0 z-50 flex">
        <div className="w-[70vw] max-w-xs h-full bg-gradient-to-b from-[#1a1440] to-[#181A2A] border-r border-[#23244a] shadow-xl pt-6 flex flex-col animate-slide-in-left">
