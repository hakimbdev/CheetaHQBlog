              ...
              <div key={post.id} className="bg-[#23214a] rounded-xl p-6 border border-[#2d295e] hover:border-purple-500 transition-all duration-300 group">
                ...
                <div className="space-y-3">
                  ...
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg font-medium hover:from-purple-600 hover:to-pink-600 transition-all duration-300 flex items-center justify-center space-x-2"
                  >
                    <span>Read More</span>
            ...
            {mockBlogPosts.map((post) => (
              <div key={post.id} className="bg-[#23214a] rounded-xl p-4 border border-[#2d295e] hover:border-purple-500 transition-all duration-300 group">
                ...
                <div className="space-y-2">
                  ...
                  <button 
                    onClick={() => handleReadMore(post)}
                    className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg text-sm font-medium hover:from-purple-600 hover:to-pink-600 transition-all duration-300 flex items-center justify-center space-x-2"
                  >
                    <span>Read More</span>
